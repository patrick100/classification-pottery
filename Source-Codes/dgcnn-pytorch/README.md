...
``` 2048 points
python main.py --exp_name=dgcnn_2048 --model=dgcnn --num_points=2048 --k=8 --use_sgd=True
```
...
``` 2048 points
python main.py --exp_name=dgcnn_2048_eval --model=dgcnn --num_points=2048 --k=8 --use_sgd=True --eval=True --model_path=checkpoints/dgcnn_2048/models/model.t7
```
...
``` 2048 points
python main.py --exp_name=dgcnn_2048_eval --model=dgcnn --num_points=2048 --k=8 --use_sgd=True --eval=True --model_path=pretrained/model.2048.t7
```
