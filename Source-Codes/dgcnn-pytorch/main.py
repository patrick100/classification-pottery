...
def train(args, io):
    ...
    for epoch in range(args.epochs):
        ...
        if(epoch>=199):
            ...
            print("saving")
            np.savez('peruvian/data_matrix_confusion'+'_'+str(epoch)+'.npz', y_test=test_true, y_pred=test_pred,val_overall_acc=test_acc)
            plot_confusion_matrix(str(epoch),test_true, test_pred, classes=class_names, normalize=True,title='Confussion Matrix'+str(round(test_acc,2))+'%')
        """
