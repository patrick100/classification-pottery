...
class ModelNetTrainer(object):
    ...
    def train(self, n_epochs):
        ...
        for epoch in range(n_epochs):
            ...
            if(epoch>=39):
                ...
                np.savez('geodesic_max128/data_matrix_confusion_geodesic_max128'+'_'+str(epoch+1)+'.npz', y_test=y_test, y_pred=y_pred,val_overall_acc=val_overall_acc)
    ...
    def update_validation_accuracy(self, epoch):
        ...
        wrong_class = np.zeros(8)
        samples_class = np.zeros(8)
        all_loss = 0
