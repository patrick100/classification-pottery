...
parser.add_argument("-train_path", type=str, default="pottery_geodesic_m128/*/train")
parser.add_argument("-val_path", type=str, default="pottery_geodesic_m128/*/test")
...
if __name__ == '__main__':
    ...
    cnet = SVCNN(args.name, nclasses=8, pretraining=pretraining, cnn_name=args.cnn_name)
    ...
    create_folder(log_dir)
    cnet_2 = MVCNN(args.name, cnet, nclasses=8, cnn_name=args.cnn_name, num_views=args.num_views)
    del cnet
