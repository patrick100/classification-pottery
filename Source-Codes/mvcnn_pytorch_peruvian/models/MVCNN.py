...
class SVCNN(Model):
    ...
    def __init__(self, name, nclasses=8, pretraining=True, cnn_name='vgg11'):
        super(SVCNN, self).__init__(name)
        """
        self.classnames=['botella',
        'cantaro',
        'cuenco',
        'figurina',
        'lebrillo',
        ...
        if self.use_resnet:
            ...
            self.net_2._modules['6'] = nn.Linear(4096,8)
...
class MVCNN(Model):
    ...
    def __init__(self, name, model, nclasses=8, cnn_name='vgg11', num_views=12):
