...
data = np.load('data_matrix_confusion_'+INPUT)
y_test = data['y_test']
y_pred = data['y_pred']
...
plot_confusion_matrix(INPUT,y_test, y_pred, classes=class_names, normalize=True,title='Confussion Matrix for 3D Peruvian Dataset '+str(format(val_overall_acc,'.2f'))+'%')