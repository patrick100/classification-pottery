...
path = './pottery_dataset_cleaned/'
path1 = './pottery_dataset_aligned/'
...
def convert_txt(path,categories,DataGroup):
	...
	for cat  in categories:
		...
		for file_index,file in enumerate(files):
			...
			command = " ".join(["meshlabserver","-i","'"+path + cat + '/'+DataGroup+'/' + file+"'","-o","'"+path1 + cat +'/'+DataGroup+'/' + file+"'","-s","./script3.mlx"])
